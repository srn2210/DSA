...
class QuickSort {
    ...
    // It works by randomly picking any pivot element from the given array -
    // - and then placing the pivot into its sorted position, and placing -
    // - the values smaller than it to its left, and the values greater than -
    // - it to its right. We then recursively call this partition and sort -
    // - technique to all the elements in the range to the left of the pivot -
    // - and to the elements in the range right of the pivot.
    ...
    public static void main(String[] args) {
        ...
        int[] arr = new int[]{101, 29, 33, 107, 95, 96};
